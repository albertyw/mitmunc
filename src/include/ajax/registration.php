...
$subject = "[MITMUNC 2016] $school->schoolName Registration";
...
"to have you on board for our eigth annual conference.<br /><br />" .
"<b>Your username is $user->username and your password is $password.</b><br /><br />" .
"You can now visit <a href=\"http://mitmunc.mit.edu/login\">http://mitmunc.mit.edu/login</a> to log onto your school's account.\n";  
...
"<b>Your username is $user->username and your password is $password.</b><br /><br />" .
"You can now visit <a href=\"http://mitmunc.mit.edu/login\">http://mitmunc.mit.edu/login</a> to log onto your school's account.<br /><br />\n".
...
$message .= "To see your invoice, click \"Invoice\" in the Make Payment page.  If you have any questions, please feel free to contact me by e-mail at <a href=\"mailto:info@mitmunc.mit.edu\">info@mitmunc.mit.edu</a>.<br />\n\n";
...
$message .= "Aofei Liu<br />\n";
$waitMsg .= "Cory Hernandez<br />\n";

$message .= "MITMUNC 2016 Charg&eacute;e d'Affaires<br />";
$waitMsg .= "MITMUNC 2014 Charg&eacute;e d'Affaires<br />";
...
"MITMUNC is characterized by our small committee size of less than or equal to 55 delegates per committee. In our attempts to keep our committee sizes small, we can only accommodate as many delegates as we can fit into our committees. Unfortunately, we are close to hitting our estimated capacity.<br /><br />".
"<b>You will receieve an e-mail to confirm if your school is registered within 48 hours.</b> <br /><br />".
"We apologize for any inconveniences caused by our sudden change in registration policy. Please let us know if you have any concerns or questions. We are trying our best to increase our conference size for future years.<br /><br />";
...
$waitMsg2 .= "Jiapei Chen<br />\n";

$waitMsg2 .= "MITMUNC 2015 Charg&eacute;e d'Affaires<br />";
