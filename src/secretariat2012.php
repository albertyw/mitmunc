...
<td>Email: <?php echo obfuscateEmail('usg@mitmunc.org').', '.obfuscateEmail('webmaster@mitmunc.org');?><br />
...
and Charg&eacute; d'Affaires (2011).  I also coded the mitmunc.org website.  This year, as the Under-Secretary-General, I will be in charge of 
...
<td>Email: <?php echo obfuscateEmail('cto@mitmunc.org'); ?><br />
...
<td>Email: <?php echo obfuscateEmail('pr@mitmunc.org'); ?><br />
