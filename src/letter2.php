...
<center>
<div style="font-size:large">font-size:large”><center>
Invitation To MITMUNC <?php generalInfoReader('conferenceYear’); ?>
</div></center>

<p>Dear Delegates and Faculty Advisers,</p>

<p>
It gives me great pleasure and distinct honor to invite you to the sixth annual Massachusetts Institute of Technology Model United Nations Conference (MITMUNC), held on the weekend of 
<?php echo date('F j-',  generalInfoReader('conferenceStartDate')); echo date('j, Y', generalInfoReader('conferenceEndDate')); ?></p>
...
<p>
Our chairs, students studying at the MIT, combine their scientific expertise with their passion for international politics and relations to make scientific issues accessible to the students in the MUN format. We aim for all student delegates to improve their debate and public speaking skills, while simultaneously gaining a reverence for the scientific basis behind their arguments.</p>
<p>
...
<p>
Now in our seventh year, MITMUNC staff will be more experienced than ever before. Many of our Staff and Secretariat members have MUN experience at the high school and college levels. They have chaired and participated as delegates at several conferences--locally and internationally. We are excited to have grown so quickly with the help of schools like yours, and we hope you will join us in making the history of MITMUNC.
</p>

<p>The deadline and fees for MITMUNC 2015 registration are outlined below:</p>

<p><b>Registration--due October 26, 2014</b>
<ul>
<li>$60 per delegate</li>
<li>$80 for the school</li>
</ul></p>
<p>
Registration for the conference will open on September 26, 2014. This year, MITMUNC will only have one registration deadline. All schools that register after our deadline will be automatically placed on our waitlist, as we cannot guarantee spots thereafter.</p>
<p>
...
<p>
You can register your delegation and view additional information about our conference by visiting http://mitmunc.mit.edu/. If you have any questions about MITMUNC, we encourage you to email info@mitmunc.mit.edu for more information.</p>

<p>
We look forward to hearing from you soon!</p>
<p>
Jiapei Chen</p>
<p>Charg&eacute;e d'Affaires</p>
<p>MITMUNC VII 2015</p>
<p><a href="mailto:mun-exec@mit.edu">mun-exec@mit.edu</a>
<p>(601) 5-MITMUN</p>
<p>(601) 564-8686</p>
