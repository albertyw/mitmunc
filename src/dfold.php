...
later but before <?php echo date('F j, Y',generalInfoReader('paymentDueDate'))?>.  We accept payment via wire transfer or a check made out "MIT Model United Nations".  We are unable to accept credit card payments this year. <b>There is no early or late registration this year, as in the past.  All schools must register by the listed date.</b>
</p>
<ul>
<!--
...
-->
<li>School Registration Fee: $<?php echo generalInfoReader('regularSchoolFee'); ?> <b>for schools with >5 delegates.</b>
<ul><li><!--Regular-->Registration School Fee Payment Deadline: <?php echo date('F j, Y',generalInfoReader('regularRegDeadline'))?></li></ul></li></br>
<li>Delegate Fee: $<?php echo generalInfoReader('regularDelegateFee')?> per delegate 
</li>
<ul><li><!--Regular-->Delegate Fee Payment Deadline: <?php echo date('F j, Y', generalInfoReader('paymentDueDate'))?></li></ul></li></br>
...
<!--
&nbsp;&nbsp;Ryan McDermott<br />
&nbsp;&nbsp;500 Memorial Drive, 70 Amherst St.<br />
&nbsp;&nbsp;Rm. 312-C<br />
...
<ul>
<li>Attendee Lists Due on Control Panel: January 15, 2014</li>
<li>Position Papers Due to the Delegate's Committee Chair: January 31, 2014</li>
</ul>
...
Please contact <?php echo obfuscateEmail('info@mitmunc.mit.edu'); ?> with any questions or concerns about fees.
